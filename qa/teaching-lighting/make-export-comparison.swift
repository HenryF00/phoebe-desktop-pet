...
let paths=["assets/pet/frames/master.png","qa/teaching-lighting/before-pointer-up.png","qa/teaching-lighting/original-source-fixed-export-up.png","assets/pet/frames/teaching-pointer-up.png","assets/pet/frames/teaching-pointer-level.png"]
let labels=["Original master","Old export","Original + fixed export","Edited + fixed export","Edited level + fixed export"]
...
try out.representation(using:.png,properties:[:])!.write(to:root.appendingPathComponent("qa/teaching-lighting/export-comparison.png"))
print("export-comparison.png")
